"""
Модуль внесення обробки оцінок школярів. Структура даних - словник, ключем якого
є кортеж із двох рядків (Клас,ПІБ школяра), якому відповідає інший словник. У вкладеному
словнику ключем є назва предмету, а значенням - список із оцінками школяра
по цьому предмету. Наприклад:
